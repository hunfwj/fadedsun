...
```
# get https://go-mod-proxy.byted.org/gopkg.in/mgo.v2/@v/v2.0.0-20190816093944-a6b53ec6cb22.zip: 200 OK (0.667s)
# get https://go-mod-proxy.byted.org/github.com/gogo/protobuf/@v/v1.3.1.zip: 200 OK (0.686s)
```
